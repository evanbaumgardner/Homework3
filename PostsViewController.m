...
#pragma mark - PostsDetailViewControllerDelegate

- (void)postsDetailViewControllerDidCancel:(PostsDetailViewController *)controller
{
    [self dismissViewControllerAnimated:YES completion:nil];
}

- (void)postsDetailViewControllerDidSave:(PostsDetailViewController *)controller
{
    [self dismissViewControllerAnimated:YES completion:nil];
}
